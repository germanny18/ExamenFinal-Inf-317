...
package local_project.alumno_0_1;
...
/**
 * Job: Alumno Purpose: Alumno<br>
 * Description: Alumno <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Alumno implements TalendJob {
	...
	private final String jobName = "Alumno";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Alumno.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class cargaStruct implements routines.system.IPersistableRow<cargaStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Alumno = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Alumno = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final cargaStruct other = (cargaStruct) obj;
		...
		public void copyDataTo(cargaStruct other) {
		...
		public void copyKeysDataTo(cargaStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Alumno.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_Alumno.length == 0) {
						commonByteArray_LOCAL_PROJECT_Alumno = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_Alumno = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_Alumno, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_Alumno, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_Alumno, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_Alumno, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_Alumno) {
		 ...
		 * Compare keys
		 */
		public int compareTo(cargaStruct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				cargaStruct carga = new cargaStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "carga");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("alumno");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("alumno");
				}
				...
				String url_tDBOutput_1 = "jdbc:postgresql://" + "localhost" + ":" + "5432" + "/" + "empleados";
				dbUser_tDBOutput_1 = "postgres";

				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:ml5v5cyCQzMwTO3kycHq/b4xfvqdcDJAioylFpk16Q5V");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("alumno")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"id\" INT4 ,\"nombre\" VARCHAR(20)  ,\"apellido\" VARCHAR(20)  ,primary key(\"id\"))");
				}
...
// # Outputs initialization
				cargaStruct carga_tmp = new cargaStruct();
// ###############################
				...
				Object source_tFileInputExcel_1 = "C:/Users/Carlos/Desktop/Libro1.xls";
...
//end%>
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.nombre = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.nombre = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "apellido";
									row1.apellido = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.apellido = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// # Output table : 'carga'
									carga_tmp.id = row1.id;
									carga_tmp.nombre = row1.nombre;
									carga_tmp.apellido = row1.apellido;
									carga = carga_tmp;
// ###############################
...
// Start of branch "carga"
								if (carga != null) {
									...
									if (carga.id == null) {
										...
										pstmt_tDBOutput_1.setInt(1, carga.id);
									}

									if (carga.nombre == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, carga.nombre);
									}

									if (carga.apellido == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, carga.apellido);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "carga");
				}
	...
	public static void main(String[] args) {
		final Alumno AlumnoClass = new Alumno();

		int exitCode = AlumnoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Alumno.class.getClassLoader()
					.getResourceAsStream("local_project/alumno_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Alumno.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Alumno");
		}
...
/************************************************************************************************
 * 69371 characters generated by Talend Open Studio for Data Integration on the
 * 12 de diciembre de 2022, 12:18:11 CST
 ************************************************************************************************/